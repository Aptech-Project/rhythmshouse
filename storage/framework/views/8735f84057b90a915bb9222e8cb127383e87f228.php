<!-- <?php echo e(asset('')); ?> -->
 <?php $__env->startSection('title', 'RhythmHouse | Product'); ?> <?php $__env->startSection('content'); ?>
<!-- Breadcrumb Begin -->
                    ...
                    <div class="videos__slider owl-carousel">
                        <div class="col-lg-3">
                            <div class="videos__item">
                                <div class="videos__item__pic set-bg" data-setbg="<?php echo e(asset('img/videos/videos-1.jpg')); ?>">
                        ...
                        <div class="col-lg-3">
                            <div class="videos__item">
                                <div class="videos__item__pic set-bg" data-setbg="<?php echo e(asset('img/videos/videos-2.jpg')); ?>">
                        ...
                        <div class="col-lg-3">
                            <div class="videos__item">
                                <div class="videos__item__pic set-bg" data-setbg="<?php echo e(asset('img/videos/videos-3.jpg')); ?>">
                        ...
                        <div class="col-lg-3">
                            <div class="videos__item">
                                <div class="videos__item__pic set-bg" data-setbg="<?php echo e(asset('img/videos/videos-4.jpg')); ?>">
...
<?php echo $__env->make('web.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\rhythmhouse\branches\dev\resources\views/web/product.blade.php ENDPATH**/ ?>