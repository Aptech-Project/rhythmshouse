<aside class="main-sidebar elevation-4" style="position: fixed; background-color: #2e3b46">
    <!-- Brand Logo -->
    <a href="<?php echo e(url('admin/index')); ?>" class="brand-link" style="background-color: #1a2732">
        <img src="<?php echo e(asset('img/Logo-black1.png')); ?>" alt="Managed Page" class="brand-image img-circle elevation-3"
            style="opacity: .8">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo e(url('admin/product/productCreate')); ?>" class="nav-link">
                                <i class="nav-icon fas"></i>
                                <p style="color: ghostwhite">Add Products</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(url('admin/product/productList')); ?>" class="nav-link">
                                <i class="nav-icon fas"></i>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(url('admin/event/eventList')); ?>" class="nav-link">
                                <i class="nav-icon fas"></i>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo e(url('admin/category/categoryList')); ?>" class="nav-link">
                                <i class="nav-icon fas"></i>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo e(url('admin/user/allUsers')); ?>" class="nav-link">
                                <i class="nav-icon fas"></i>
                                <p style="color: ghostwhite">All Users</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(url('admin/user/userFeedback')); ?>" class="nav-link">
                                <i class="nav-icon fas"></i>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo e(url('admin/order/listOrder')); ?>" class="nav-link">
                                <i class="nav-icon fas"></i>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo e(url('admin/revenue/partnerDept')); ?>" class="nav-link">
                                <i class="nav-icon fas"></i>
                                <p style="color: ghostwhite">Partner Dept</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(url('admin/revenue/revenueDetails')); ?>" class="nav-link">
                                <i class="nav-icon fas"></i>
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH D:\Xampp\htdocs\rhythmhouse\branches\dev\resources\views/admin/layout/main-sidebar.blade.php ENDPATH**/ ?>