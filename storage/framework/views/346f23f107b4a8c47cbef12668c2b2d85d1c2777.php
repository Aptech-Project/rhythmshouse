...
<?php $__env->startSection('title', 'RhythmHouse | Login'); ?>
...
<section>
    <div class="wrapper" style="background-image: url('../../public/img/hero-bg.png');">
        <div class="inner">
            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo e(route('login')); ?>" style="color: antiquewhite;" style="text-align: center;">
...
unset($__errorArgs, $__bag); ?>" name="password" required autocomplete="current-password" name="password">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <p>You haven't an Account </p> <a href="<?php echo e(url('web/register')); ?>">Register now !</a>
                    </div>
                </div>
            </form>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('web.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\rhythmhouse\branches\dev\resources\views/web/login.blade.php ENDPATH**/ ?>