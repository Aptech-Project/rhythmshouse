...
<?php $__env->startSection('title', 'RhythmHouse | About'); ?>
    ...
    <section class="skills spad">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 p-0">
                    <div class="skills__video set-bg" data-setbg="<?php echo e(asset('img/skill-video.jpg')); ?>" style="height:600px">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about__pic">
                        <img src="<?php echo e(asset('img/about/about.png')); ?>" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 p-0">
                            <img src="<?php echo e(asset('img/about/ap-1.jpg')); ?>" alt="">
                            <img src="<?php echo e(asset('img/about/ap-2.jpg')); ?>" alt="">
                        </div>
                        <div class="col-lg-8 col-md-8 col-sm-8 p-0">
                            <img src="<?php echo e(asset('img/about/ap-3.jpg')); ?>" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-8 p-0">
                            <img src="<?php echo e(asset('img/about/ap-4.jpg')); ?>" alt="">
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 p-0">
                            <img src="<?php echo e(asset('img/about/ap-5.jpg')); ?>" alt="">
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 p-0">
                            <img src="<?php echo e(asset('img/about/ap-6.jpg')); ?>" alt="">
                        </div>
                        <div class="col-lg-8 col-md-8 col-sm-8 p-0">
                            <img src="<?php echo e(asset('img/about/ap-7.jpg')); ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="about__services__item">
                        <div class="about__services__item__pic set-bg" data-setbg="<?php echo e(asset('img/services/as-1.jpg')); ?>">
                            <div class="icon">
                                <img src="<?php echo e(asset('img/services/as-icon-1.png')); ?>" alt="">
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="about__services__item">
                        <div class="about__services__item__pic set-bg" data-setbg="<?php echo e(asset('img/services/as-2.jpg')); ?>">
                            <div class="icon">
                                <img src="<?php echo e(asset('img/services/as-icon-2.png')); ?>" alt="">
                            </div>
                        </div>
                        <div class="about__services__item__text">
                            <h4>Clubs and bar</h4>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="about__services__item">
                        <div class="about__services__item__pic set-bg" data-setbg="<?php echo e(asset('img/services/as-3.jpg')); ?>">
                            <div class="icon">
                                <img src="<?php echo e(asset('img/services/as-icon-3.png')); ?>" alt="">
                            </div>
                        </div>
                        <div class="about__services__item__text">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('web.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\rhythmhouse\branches\dev\resources\views/web/about.blade.php ENDPATH**/ ?>