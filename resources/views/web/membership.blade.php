            ...
            <div class="center set-bg spad" style="margin-top: 10vw; margin-bottom: 5vw; background-color:#F6F6F6; opacity: 0.9">
                ...
                <div class="row">
                    <div class="col-md-6" style="text-align: center">
                        <img src="{{asset('img/competition-AE.jpg')}}" width="70%">
                    </div>
                    <div class="col-md-6" style="vertical-align: middle text-align: center">
                        <div class="membership-offers">
                            <img src="{{asset('img/bullet.png')}}" width="5%">&nbsp;Have a chance to Win an American Epic companion book & Collector's music boxset.<br><br>
                            <img src="{{asset('img/bullet.png')}}" width="5%">&nbsp;Get 50% pay off ticket for the first oder.<br><br>
                            <img src="{{asset('img/bullet.png')}}" width="5%">&nbsp;Instant Savings are loaded directly to your membership card within 72 hours.<br><br>
                            <img src="{{asset('img/bullet.png')}}" width="5%">&nbsp;Instant Savings expire 30 days after membership activation.<br>
                        </div>
                    </div>
                </div>
