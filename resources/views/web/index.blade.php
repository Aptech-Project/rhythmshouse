...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-7 p-0">
                    <div class="track__content nice-scroll">
                        @foreach ($billboard as $key=>$b) 
                        <div class="single_player_container">
                            <h4>{{$key + 1}}. {{$b->name}}</h4>
                            <div class="jp-jplayer jplayer" data-ancestor=".jp_container_{{$b->id}}"
                                data-url="{{ asset('music-files/'.$b->demo) }}"></div>
                            <div class="jp-audio jp_container_{{$b->id}}" role="application" aria-label="media player">
    ...
    <section class="youtube spad">
        <div class="container">
            ...
            <div class="row">
                @foreach ($lastestProducts as $lp)
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="youtube__item">
                        <a href="{{ url('web/productDetail/'.$lp->id) }}">
                            <div class="youtube__item__pic set-bg" data-setbg="{{ url('images/'.$lp->image) }}">
                            </div>
                        </a>
                        <div class="youtube__item__text center">
                            <h4>{{$lp->name}}</h4>
                        </div>
                    </div>
                </div>
